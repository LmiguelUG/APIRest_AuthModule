...
from authentication.views import LoginAPIView, LogoutAPIView, RegisterView, PasswordTokenCheckAPI,VerifyEmailAPIView, RequestPasswordResetEmail, ProfileAPIView, SetNewPasswordAPIView
